...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "lnt-raintree-boulevard"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="LnT Raintree Boulevard"/>
            <br/>
           <OverviewComonent project="Raintree Boulevard Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Raintree Boulevard Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Raintree Boulevard Amenities"/>
           <hr/>
           <PricingComponent project="Raintree Boulevard Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Raintree Boulevard Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
