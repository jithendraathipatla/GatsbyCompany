...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "salarpuria-sattva-luxuria"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Salarpuria Sattva Luxuria"/>
            <br/>
           <OverviewComonent project="Luxuria Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Luxuria Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Luxuria Amenities"/>
           <hr/>
           <PricingComponent project="Luxuria Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Luxuria Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
