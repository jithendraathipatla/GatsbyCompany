...
const Sankya = () => {
    ...
    return (
        ...
        <HeroComponent img={mainImage} quote1="Soba Silicon Oasis"/>
           ...
           <hr/>
           <ConfigurationComponent project="Silicon Oasis Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Silicon Oasis Amenities"/>
           <hr/>
           <PricingComponent project="Silicon Oasis Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Silicon Oasis Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
