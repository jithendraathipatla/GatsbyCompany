...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "habitat-iluminar"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Habitat Iluminar"/>
            <br/>
           <OverviewComonent project="Iluminar Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Iluminar Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Iluminar Amenities"/>
           <hr/>
           <PricingComponent project="Iluminar Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Iluminar Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
