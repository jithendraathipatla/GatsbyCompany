...
const Sankya = () => {
    ...
    return (
        ...
        <HeroComponent img={mainImage} quote1="Dnr Reflection"/>
           ...
           <hr/>
           <ConfigurationComponent project="Reflection Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Reflection Amenities"/>
           <hr/>
           <PricingComponent project="Reflection Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Reflection Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
