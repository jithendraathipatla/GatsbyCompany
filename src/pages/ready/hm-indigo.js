...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "hm-indigo"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="HM Indigo"/>
            <br/>
           <OverviewComonent project="Indigo Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Indigo Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Indigo Amenities"/>
           <hr/>
           <PricingComponent project="Indigo Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Indigo Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
