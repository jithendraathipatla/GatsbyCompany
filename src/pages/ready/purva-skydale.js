...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "purva-skydale"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Purva Skydale"/>
            <br/>
           <OverviewComonent project="Skydale Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Skydale Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Skydale Amenities"/>
           <hr/>
           <PricingComponent project="Skydale Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Skydale Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
