...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "century-central"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Century Central"/>
            <br/>
           <OverviewComonent project="Centeral Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Centeral Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Centeral Amenities"/>
           <hr/>
           <PricingComponent project="Centeral Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Centeral Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
