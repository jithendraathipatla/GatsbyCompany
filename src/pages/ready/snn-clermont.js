...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "snn-clermont"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="SNN Clermont"/>
            <br/>
           <OverviewComonent project="Clermont Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Clermont Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Clermont Amenities"/>
           <hr/>
           <PricingComponent project="Clermont Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Clermont Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
