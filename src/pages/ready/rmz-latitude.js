...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "rmz-latitude"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="RMZ Latitude"/>
            <br/>
           <OverviewComonent project="RMZ Latitude Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="RMZ Latitude Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="RMZ Latitude Amenities"/>
           <hr/>
           <PricingComponent project="RMZ Latitude Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="RMZ Latitude Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
