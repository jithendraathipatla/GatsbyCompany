...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "salarpuria-sattva-cadenza"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Salarpuria Sattva Cadenza"/>
            <br/>
           <OverviewComonent project="Cadenza Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Cadenza Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Cadenza Amenities"/>
           <hr/>
           <PricingComponent project="Cadenza Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Cadenza Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
