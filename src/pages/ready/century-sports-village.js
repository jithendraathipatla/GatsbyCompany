...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "century-sports-village"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Century Sports Village"/>
            <br/>
           <OverviewComonent project="Sports Village Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Sports Village Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Sports Village Amenities"/>
           <hr/>
           <PricingComponent project="Sports Village Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Sports Village Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
