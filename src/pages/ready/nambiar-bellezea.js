...
const Sankya = () => {
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Nambiar Bellezea"/>
            <br/>
           <OverviewComonent project="Bellezea Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Bellezea Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Bellezea Amenities"/>
           <hr/>
           <PricingComponent project="Bellezea Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Bellezea Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
