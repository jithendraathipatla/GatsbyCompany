...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "brigade-caladium"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Brigade Caladium"/>
            <br/>
           <OverviewComonent project="Caladium Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Caladium Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Caladium Amenities"/>
           <hr/>
           <PricingComponent project="Caladium Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Caladium Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
