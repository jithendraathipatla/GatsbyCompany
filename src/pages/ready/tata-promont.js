...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "tata-promont"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Tata Promont"/>
            <br/>
           <OverviewComonent project="Promont Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Promont Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Promont Amenities"/>
           <hr/>
           <PricingComponent project="Promont Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Promont Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
