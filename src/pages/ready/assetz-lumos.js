...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "assetz-lumos"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Assetz Lumos"/>
            <br/>
           <OverviewComonent project="Lumos Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Lumos Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Lumos Amenities"/>
           <hr/>
           <PricingComponent project="Lumos Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Lumos Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
