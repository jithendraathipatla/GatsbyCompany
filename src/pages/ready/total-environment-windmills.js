...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "total-environment-windmills"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Total Environment Windmills"/>
            <br/>
           <OverviewComonent project="Environment Windmills Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Environment Windmills Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Environment Windmills Amenities"/>
           <hr/>
           <PricingComponent project="Environment Windmills Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Environment Windmills Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
