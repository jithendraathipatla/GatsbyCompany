...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "mahindra-windchimes"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Mahindra Windchimes"/>
            <br/>
           <OverviewComonent project="Windchimes Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Windchimes Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Windchimes Amenities"/>
           <hr/>
           <PricingComponent project="Windchimes Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Windchimes Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
