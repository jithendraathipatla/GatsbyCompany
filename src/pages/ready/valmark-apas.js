...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "valmark-apas"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Valmark Apas"/>
            <br/>
           <OverviewComonent project="Apas Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Apas Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Apas Amenities"/>
           <hr/>
           <PricingComponent project="Apas Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Apas Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
