...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "axis-tatvam"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Axis Tatvam"/>
            <br/>
           <OverviewComonent project="Tatvam Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Tatvam Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Tatvam Amenities"/>
           <hr/>
           <PricingComponent project="Tatvam Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Tatvam Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
