...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "provident-sunworth"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Provident Sunworth"/>
            <br/>
           <OverviewComonent project="Sunworth Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Sunworth Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Sunworth Amenities"/>
           <hr/>
           <PricingComponent project="Sunworth Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Sunworth Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
