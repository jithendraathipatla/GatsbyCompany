...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "pride-crosswinds"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Pride Crosswinds"/>
            <br/>
           <OverviewComonent project="Crosswinds Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Crosswinds Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Crosswinds Amenities"/>
           <hr/>
           <PricingComponent project="Crosswinds Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Crosswinds Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
