...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "sobha-morzaria-grandeur"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Sobha Morzaria Grandeur"/>
            <br/>
           <OverviewComonent project="Morzaria Grandeur Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Morzaria Grandeur Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Morzaria Grandeur Amenities"/>
           <hr/>
           <PricingComponent project="Morzaria Grandeur Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Morzaria Grandeur Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
