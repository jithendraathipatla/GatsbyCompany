...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "snn-raj-greenbay"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="SNN Raj Greenbay"/>
            <br/>
           <OverviewComonent project="Greenbay Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Greenbay Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Greenbay Amenities"/>
           <hr/>
           <PricingComponent project="Greenbay Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Greenbay Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
