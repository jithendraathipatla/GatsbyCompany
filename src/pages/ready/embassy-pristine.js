...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "embassy-pristine"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Embassy Pristine"/>
            <br/>
           <OverviewComonent project="Pristine Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Pristine Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Pristine Amenities"/>
           <hr/>
           <PricingComponent project="Pristine Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Pristine Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
