...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "axis-vedam"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Axis Vedam"/>
            <br/>
           <OverviewComonent project="Vedam Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Vedam Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Vedam Amenities"/>
           <hr/>
           <PricingComponent project="Vedam Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Vedam Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
