...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "vaswani-walnut-creek"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Vaswani Walnut Creek"/>
            <br/>
           <OverviewComonent project="Walnut Creek Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Walnut Creek Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Walnut Creek Amenities"/>
           <hr/>
           <PricingComponent project="Walnut Creek Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Walnut Creek Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
