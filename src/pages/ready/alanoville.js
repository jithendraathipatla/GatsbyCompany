...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "alanoville"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Alanoville"/>
            <br/>
           <OverviewComonent project="Alanoville Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Alanoville Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Alanoville Amenities"/>
           <hr/>
           <PricingComponent project="Alanoville Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Alanoville Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
