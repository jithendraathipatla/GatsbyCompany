...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "salarpuria-sattva-celesta"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Salarpuria Sattva Celesta"/>
            <br/>
           <OverviewComonent project="Celesta Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Celesta Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Celesta Amenities"/>
           <hr/>
           <PricingComponent project="Celesta Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Celesta Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
