...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "tata-new-haven"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Tata New Haven"/>
            <br/>
           <OverviewComonent project="New Haven Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="New Haven Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="New Haven Amenities"/>
           <hr/>
           <PricingComponent project="New Haven Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="New Haven Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
