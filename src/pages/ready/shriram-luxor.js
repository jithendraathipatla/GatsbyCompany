...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "shriram-luxor"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Shiram Luxor"/>
            <br/>
           <OverviewComonent project="Luxor Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Luxor Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Luxor Amenities"/>
           <hr/>
           <PricingComponent project="Luxor Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Luxor Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
