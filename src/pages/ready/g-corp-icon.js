...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "g-corp-icon"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="G Corp Icon"/>
            <br/>
           <OverviewComonent project="G Corp Icon Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="G Corp Icon Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="G Corp Icon Amenities"/>
           <hr/>
           <PricingComponent project="G Corp Icon Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="G Corp Icon Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
