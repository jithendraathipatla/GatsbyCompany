...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "brigade-omega"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Brigade Omega"/>
            <br/>
           <OverviewComonent project="Omega Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Omega Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Omega Amenities"/>
           <hr/>
           <PricingComponent project="Omega Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Omega Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
