...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "godrej-e-city"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Godrej E City"/>
            <br/>
           <OverviewComonent project="E City Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="E City Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="E City Amenities"/>
           <hr/>
           <PricingComponent project="E City Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="E City Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
