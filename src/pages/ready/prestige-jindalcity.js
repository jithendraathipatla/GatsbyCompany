...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "prestige-jindalcity"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Prestige JindalCity"/>
            <br/>
           <OverviewComonent project="JindlCity Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="JindlCity Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="JindlCity Amenities"/>
           <hr/>
           <PricingComponent project="JindlCity Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="JindlCity Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
