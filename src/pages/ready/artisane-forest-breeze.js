...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "artisane-forest-breeze"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Artisane-forest-breeze"/>
            <br/>
           <OverviewComonent project="Forest Breeze Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Forest Breeze Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Forest Breeze Amenities"/>
           <hr/>
           <PricingComponent project="Forest Breeze Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Forest Breeze Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
