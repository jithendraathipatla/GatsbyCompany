...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "purva-sunflower"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Purva Sunflower"/>
            <br/>
           <OverviewComonent project="Sunflower Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Sunflower Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Sunflower Amenities"/>
           <hr/>
           <PricingComponent project="Sunflower Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Sunflower Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
