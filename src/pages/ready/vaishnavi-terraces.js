...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "vaishnavi-terraces"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Vaishnavi Terraces"/>
            <br/>
           <OverviewComonent project="Vaishnavi Terraces Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Vaishnavi Terraces Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Vaishnavi Terraces Amenities"/>
           <hr/>
           <PricingComponent project="Vaishnavi Terraces Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Vaishnavi Terraces Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
