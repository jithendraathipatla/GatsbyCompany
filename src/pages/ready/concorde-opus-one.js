...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "concorde-opus-one"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Concorde Opus One"/>
            <br/>
           <OverviewComonent project="Opus One Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Opus One Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Opus One Amenities"/>
           <hr/>
           <PricingComponent project="Opus One Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Opus One Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
