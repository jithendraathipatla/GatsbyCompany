...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "salarpuria-sattva-aspire"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Salarpuria Sattva Aspire"/>
            <br/>
           <OverviewComonent project="Aspire Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Aspire Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Aspire Amenities"/>
           <hr/>
           <PricingComponent project="Aspire Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Aspire Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
