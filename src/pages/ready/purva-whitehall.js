...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "purva-whitehall"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Purva Whitehall"/>
            <br/>
           <OverviewComonent project="Whitehall Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Whitehall Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Whitehall Amenities"/>
           <hr/>
           <PricingComponent project="Whitehall Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Whitehall Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
