...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "sowparnika-swastika"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Sowparnika Swastika"/>
            <br/>
           <OverviewComonent project="Swastika Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Swastika Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Swastika Amenities"/>
           <hr/>
           <PricingComponent project="Swastika Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Swastika Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
