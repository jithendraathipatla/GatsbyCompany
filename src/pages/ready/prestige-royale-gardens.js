...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "prestige-royale-gardens"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Prestige Royale Gardens"/>
            <br/>
           <OverviewComonent project="Royale Gardens Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Royale Gardens Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Royale Gardens Amenities"/>
           <hr/>
           <PricingComponent project="Royale Gardens Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Royale Gardens Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
