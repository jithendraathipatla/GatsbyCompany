...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "snn-raj-spiritua"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="SNN Raj Spiritua"/>
            <br/>
           <OverviewComonent project="Spiritua Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Spiritua Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Spiritua Amenities"/>
           <hr/>
           <PricingComponent project="Spiritua Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Spiritua Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
