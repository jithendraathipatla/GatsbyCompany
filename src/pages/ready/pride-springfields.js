...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "pride-springfields"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Pride Springfields"/>
            <br/>
           <OverviewComonent project="Springfields Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Springfields Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Springfields Amenities"/>
           <hr/>
           <PricingComponent project="Springfields Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Springfields Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
