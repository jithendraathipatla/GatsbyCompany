...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "embassy-lake-terraces"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Embassy Lake Terraces"/>
            <br/>
           <OverviewComonent project="LAke Terraces Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="LAke Terraces Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="LAke Terraces Amenities"/>
           <hr/>
           <PricingComponent project="LAke Terraces Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="LAke Terraces Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
