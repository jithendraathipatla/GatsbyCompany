...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "brigade-exotica"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Brigade Exotica"/>
            <br/>
           <OverviewComonent project="Exotica Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Exotica Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Exotica Amenities"/>
           <hr/>
           <PricingComponent project="Exotica Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Exotica Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
