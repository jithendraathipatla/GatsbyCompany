...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "penisula-heights"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Penisula Heights"/>
            <br/>
           <OverviewComonent project="Penisula Heights Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Penisula Heights Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Penisula Heights Amenities"/>
           <hr/>
           <PricingComponent project="Penisula Heights Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Penisula Heights Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
