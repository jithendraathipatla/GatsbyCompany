...
const Sankya = () => {
    const dataweneed = ReadyToMoveInData.filter((item)=>{
        return item.redirect === "sobha-city"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Sobha City"/>
            <br/>
           <OverviewComonent project="City Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="City Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="City Amenities"/>
           <hr/>
           <PricingComponent project="City Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="City Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
