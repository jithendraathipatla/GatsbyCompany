...
const Assertzmarq = () => {
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Provident Capella"/>
            <br/>
           <OverviewComonent project="Capella Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Capella Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Capella Amenities"/>
           <hr/>
           <PricingComponent project="Capella Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Capella Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
