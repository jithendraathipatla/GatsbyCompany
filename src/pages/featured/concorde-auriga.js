...
const Assertzmarq = () => {
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Concorde Auriga"/>
            <br/>
           <OverviewComonent project="Auriga Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Auriga Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Auriga Amenities"/>
           <hr/>
           <PricingComponent project="Auriga Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Auriga Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
