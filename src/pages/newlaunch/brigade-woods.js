...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "brigade-woods"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Brigade Woods"/>
            <br/>
           <OverviewComonent project="Woods Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Woods Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Woods Amenities"/>
           <hr/>
           <PricingComponent project="Woods Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Woods Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
