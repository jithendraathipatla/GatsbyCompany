...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "godrej-reserve-devanahalli"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Godrej Reserve"/>
            <br/>
           <OverviewComonent project="Reserve Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Reserve Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Reserve Amenities"/>
           <hr/>
           <PricingComponent project="Reserve Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Reserve Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
