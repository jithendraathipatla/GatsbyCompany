...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "casagrand-lorenza"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Casagrand Lorenza"/>
            <br/>
           <OverviewComonent project="Lorenza Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Lorenza Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Lorenza Amenities"/>
           <hr/>
           <PricingComponent project="Lorenza Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Lorenza Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
