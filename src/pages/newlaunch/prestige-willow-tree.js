...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "prestige-willow-tree"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Prestige Willow tree"/>
            <br/>
           <OverviewComonent project="Willow Tree Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Willow Tree Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Willow Tree Amenities"/>
           <hr/>
           <PricingComponent project="Willow Tree Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Willow Tree Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
