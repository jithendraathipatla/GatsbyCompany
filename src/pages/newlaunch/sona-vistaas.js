...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "sona-vistaas"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Sona Vistaas"/>
            <br/>
           <OverviewComonent project="Vistaas Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Vistaas Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Vistaas Amenities"/>
           <hr/>
           <PricingComponent project="Vistaas Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Vistaas Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
