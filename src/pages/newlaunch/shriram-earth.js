...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "shriram-earth"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Shriram Earth"/>
            <br/>
           <OverviewComonent project="Shriram Earth Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Shriram Earth Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Shriram Earth Amenities"/>
           <hr/>
           <PricingComponent project="Shriram Earth Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Shriram Earth Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
