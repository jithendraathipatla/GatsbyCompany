...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "century-greens"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Century Greens"/>
            <br/>
           <OverviewComonent project="Greens Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Greens Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Greens Amenities"/>
           <hr/>
           <PricingComponent project="Greens Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Greens Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
