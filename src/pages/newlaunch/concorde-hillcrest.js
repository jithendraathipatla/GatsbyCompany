...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "concorde-hillcrest"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Concorde Hillcrest"/>
            <br/>
           <OverviewComonent project="Hillcrest Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Hillcrest Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Hillcrest Amenities"/>
           <hr/>
           <PricingComponent project="Hillcrest Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Hillcrest Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
