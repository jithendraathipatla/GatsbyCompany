...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "incor-carmel-heights"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Incor Carmel Heights"/>
            <br/>
           <OverviewComonent project="Carmel Heights Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Carmel Heights Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Carmel Heights Amenities"/>
           <hr/>
           <PricingComponent project="Carmel Heights Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Carmel Heights Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
