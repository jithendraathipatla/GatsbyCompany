...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "provident-northern"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Provident Northern"/>
            <br/>
           <OverviewComonent project="Northern Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Northern Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Northern Amenities"/>
           <hr/>
           <PricingComponent project="Northern Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Northern Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
