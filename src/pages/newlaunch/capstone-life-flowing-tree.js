...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "capstone-life-flowing-tree"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Capstone Life Flowing Tree"/>
            <br/>
           <OverviewComonent project="Life Flowing Tree Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Life Flowing Tree Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Life Flowing Tree Amenities"/>
           <hr/>
           <PricingComponent project="Life Flowing Tree Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Life Flowing Tree Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
