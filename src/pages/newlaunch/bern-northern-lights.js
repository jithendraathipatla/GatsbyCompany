...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "bern-northern-lights"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Bern Northern Lights"/>
            <br/>
           <OverviewComonent project="Northern Lights Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Northern Lights Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Northern Lights Amenities"/>
           <hr/>
           <PricingComponent project="Northern Lights Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Northern Lights Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
