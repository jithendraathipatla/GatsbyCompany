...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "aditya-palm-grove"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Aditya Palm Grove"/>
            <br/>
           <OverviewComonent project="Palm Grove Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Palm Grove Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Palm Grove Amenities"/>
           <hr/>
           <PricingComponent project="Palm Grove Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Palm Grove Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
