...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "shriram-rainforest"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Shriram Rainforest"/>
            <br/>
           <OverviewComonent project="Rainforest Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Rainforest Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Rainforest Amenities"/>
           <hr/>
           <PricingComponent project="Rainforest Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Rainforest Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
