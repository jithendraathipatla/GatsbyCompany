...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "shriram-codename"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Shriram CodeName"/>
            <br/>
           <OverviewComonent project="CodeName Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="CodeName Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="CodeName Amenities"/>
           <hr/>
           <PricingComponent project="CodeName Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="CodeName Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
