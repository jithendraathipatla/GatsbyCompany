...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "valmark-orchards"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Valmark Orchards"/>
            <br/>
           <OverviewComonent project="Orchards Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Orchards Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Orchards Amenities"/>
           <hr/>
           <PricingComponent project="Orchards Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Orchards Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
