...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "sowparnika-indraprastha"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Sowparnika Indraprastha"/>
            <br/>
           <OverviewComonent project="Indraprastha Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Indraprastha Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Indraprastha Amenities"/>
           <hr/>
           <PricingComponent project="Indraprastha Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Indraprastha Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
