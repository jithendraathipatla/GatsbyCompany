...
const Sankya = () => {
    ...
    return (
        ...
        <HeroComponent img={mainImage} quote1="Provident Central Park"/>
            <br/>
           <OverviewComonent project="Central Park Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Central Park Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Central Park Amenities"/>
           <hr/>
           <PricingComponent project="Central Park Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Central Park Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
