...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "nambiar-ellegenza"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Nambiar Ellegenza"/>
            <br/>
           <OverviewComonent project="Ellegenza Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Ellegenza Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Ellegenza Amenities"/>
           <hr/>
           <PricingComponent project="Ellegenza Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Ellegenza Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
