...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "ajmera-nucleus"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Ajmera-nucleus"/>
            <br/>
           <OverviewComonent project="Nuecleus Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Nuecleus Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Nuecleus Amenities"/>
           <hr/>
           <PricingComponent project="Nuecleus Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Nuecleus Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
