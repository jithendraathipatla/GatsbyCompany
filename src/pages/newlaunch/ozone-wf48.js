...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "ozone-wf48"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Ozone WF-48"/>
            <br/>
           <OverviewComonent project="WF-48 Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="WF-48 Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="WF-48 Amenities"/>
           <hr/>
           <PricingComponent project="WF-48 Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="WF-48 Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
