...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "nvt-mystic-garden"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="NVT Mystic Garden"/>
            <br/>
           <OverviewComonent project="Mystic Garden Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Mystic Garden Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Mystic Garden Amenities"/>
           <hr/>
           <PricingComponent project="Mystic Garden Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Mystic Garden Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
