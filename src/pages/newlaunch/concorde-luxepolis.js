...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "concorde-luxepolis"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Concorde Luxepolis"/>
            <br/>
           <OverviewComonent project="Luxepolis Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Luxepolis Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Luxepolis Amenities"/>
           <hr/>
           <PricingComponent project="Luxepolis Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Luxepolis Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
