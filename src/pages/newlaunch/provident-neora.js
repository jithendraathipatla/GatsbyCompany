...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "provident-neora"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Provident Neora"/>
            <br/>
           <OverviewComonent project="Neora Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Neora Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Neora Amenities"/>
           <hr/>
           <PricingComponent project="Neora Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Neora Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
