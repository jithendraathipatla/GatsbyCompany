...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "sowparnika-flamenco"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Sowparnika Flamenco"/>
            <br/>
           <OverviewComonent project="Flamenco Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Flamenco Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Flamenco Amenities"/>
           <hr/>
           <PricingComponent project="Flamenco Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Flamenco Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
