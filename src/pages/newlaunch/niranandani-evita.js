...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "niranandani-evita"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Niranandini Evita"/>
            <br/>
           <OverviewComonent project="Evita Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Evita Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Evita Amenities"/>
           <hr/>
           <PricingComponent project="Evita Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Evita Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
