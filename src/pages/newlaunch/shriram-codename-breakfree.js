...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "shriram-codename-breakfree"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Shriram Codename Breakfree"/>
            <br/>
           <OverviewComonent project="Codename Breakfree Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Codename Breakfree Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Codename Breakfree Amenities"/>
           <hr/>
           <PricingComponent project="Codename Breakfree Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Codename Breakfree Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
