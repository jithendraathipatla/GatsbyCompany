...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "vaishnavi-serene"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Vaishnavi Serene"/>
            <br/>
           <OverviewComonent project="Serene Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Serene Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Serene Amenities"/>
           <hr/>
           <PricingComponent project="Serene Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Serene Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
