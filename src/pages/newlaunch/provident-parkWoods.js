...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "provident-parkWoods"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Provident ParkWoods"/>
            <br/>
           <OverviewComonent project="ParkWoods Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="ParkWoods Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="ParkWoods Amenities"/>
           <hr/>
           <PricingComponent project="ParkWoods Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="ParkWoods Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
