...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "sobha-dream-gardens"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Sobha Dream Gardens"/>
            <br/>
           <OverviewComonent project="Dream Gardens Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Dream Gardens Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Dream Gardens Amenities"/>
           <hr/>
           <PricingComponent project="Dream Gardens Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Dream Gardens Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
