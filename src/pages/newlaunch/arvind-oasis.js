...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "arvind-oasis"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Arvind Oasis"/>
            <br/>
           <OverviewComonent project="Oasis Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Oasis Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Oasis Amenities"/>
           <hr/>
           <PricingComponent project="Oasis Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Oasis Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
