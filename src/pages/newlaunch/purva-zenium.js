...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "purva-zenium"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Purva Zenium"/>
            <br/>
           <OverviewComonent project="Zenium Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Zenium Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Zenium Amenities"/>
           <hr/>
           <PricingComponent project="Zenium Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Zenium Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
