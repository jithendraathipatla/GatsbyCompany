...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "prestige-park-square"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Prestige Park Square"/>
            <br/>
           <OverviewComonent project="Park Square Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Park Square Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Park Square Amenities"/>
           <hr/>
           <PricingComponent project="Park Square Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Park Square Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
