...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "brigade-parkside-east"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Brigade Parkside East"/>
            <br/>
           <OverviewComonent project="Park side Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Park side Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Park side Amenities"/>
           <hr/>
           <PricingComponent project="Park side Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Park side Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
