...
const Sankya = () => {
    const dataweneed = NewlaunchPropertyData.filter((item)=>{
        return item.redirect === "provident-equinox"
    });
    ...
    return (
        <Layoutcomponent>
        <HeroComponent img={mainImage} quote1="Provident Eqinox"/>
            <br/>
           <OverviewComonent project="Eqinox Overview" data={overviewdata}/>
           <hr/>
           <ConfigurationComponent project="Eqinox Configuration" data={configurationdata}/>
           <hr/>
           <AmenitiesComponent project="Eqinox Amenities"/>
           <hr/>
           <PricingComponent project="Eqinox Pricing" data={pricingdata}/>
           <hr/>
           <LocationComponent project="Eqinox Location" data={locationdata}/>
        </Layoutcomponent>
    );
};
